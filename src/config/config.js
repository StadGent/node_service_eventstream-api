  ...
  static getConfig() {
    ...
    return {
        ...
        eventstream: {
            ...
            numberOfObjectsPerFragment: process.env.EVENTSTREAM_NUMBEROFOBJECTSPERFRAGMENT ? process.env.EVENTSTREAM_NUMBEROFOBJECTSPERFRAGMENT : data.eventstream.numberOfObjectsPerFragment
        },
        hva: {
